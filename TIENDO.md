...
| **4** | **Khối Quản Lý Dữ Liệu & File (Managers)** | `managers/` | 2/2 | ⏳ **Đang triển khai** | **0%** |
...
| :--- | :--- | :--- | :--- | :---: |
| `DataManager.h` | `DataManager<T>` | **👤 Kim Huệ** | Template class quản lý kho (thêm, xóa, tìm kiếm `filter`, sắp xếp `sort`) | ⏳ Chưa xong |
